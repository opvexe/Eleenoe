...
-(void)ELSinitConfingViews{
    ...
    _tagView = ({
        ...
        iv.tagSelectedBackgroundColor  = UIColorFromRGB(0xfffff);
        iv.tagSelectedTextColor  =  UIColorFromRGB(0x848484);
        iv.tagNormaTextColor  = UIColorFromRGB(0x848484);
        iv.tagSelectedBoaderColor  = [UIColor clearColor];
        iv.tagNormalBoaderColor  =  [UIColor clearColor];
        iv.tagBorderWidth  = 0.0;
        iv.tagcornerRadius  = 0;
        iv.longPressMove = NO;
        iv.delegate  = self;
